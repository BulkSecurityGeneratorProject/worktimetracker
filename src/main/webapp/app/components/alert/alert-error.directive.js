(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('worktimetrackerApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-worktimetrackerApp-error');
                var entityKey = httpResponse.headers('X-worktimetrackerApp-params');
                if (errorHeader) {
